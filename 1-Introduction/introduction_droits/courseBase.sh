...
ssh root@host01 'groupadd 1A'
ssh root@host01 'usermod -aG 1A etudiant'
...
ssh root@host01 'sudo chown -R etudiant:1A /home/etudiant'
ssh root@host01 'sudo chmod 000 /home/etudiant/Documents/fichier4.txt'
